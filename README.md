...
<body style="background-color:lightblue;">
  ...
  <h3>NOS</h3>
   ...
   <div>
    <input type="checkbox" id="Davechoice" value="18000$">
    <label for="Davechoice">Nos  - 18000$</label>
    <input type="number" value="1" min="1">
  </div>
  
   <div>
    <input type="checkbox" id="Davechoice" value="16500$">
    <label for="Davechoice">Nos (Discount price)  - 16500$</label>
    <input type="number" value="1" min="1">
  </div>
  ...
  <h3>HARNESS</h3>
   ...
   <div>
    <input type="checkbox" id="Davechoice" value="28000$">
    <label for="Davechoice">Harness  - 28000$</label>
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    ...
    <label for="ColinChoice">Standard Repair (D-S Class) - 1000$</label>
    <input type="number" value="1" min="1">
  </div>
...
<div>
  ...
  <label for="MysteryBox">Advanced Repair Kit(Free for Police Max 2) - $1000</label>
  <input type="number" value="1" min="1">
</div>
